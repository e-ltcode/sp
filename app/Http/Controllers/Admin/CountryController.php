...
class CountryController extends Controller
{
	...
	private $singular =  "Country";
	private $plural   =  "Countries";
	private $view     =  "admin.countries.";
	private $action   =  "/admin/countries";
	private $db_key   =  "id";
	private $user = [];
	private $perpage = 10;
	...
	function index(Request $request){
		...
		$data['list'] = $countries->with('languages')->get()->toArray();
		// $data['list']   =   Country::paginate($this->perpage)->toArray();
		$data['module'] = [
			'type'=>$this->type,
	...
	public function edit(Request $request,$id = NULL)
	{
		...
		$data['row'] = Country::find($id)->toArray();
