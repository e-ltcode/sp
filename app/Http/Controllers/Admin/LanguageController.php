...
class LanguageController extends Controller
{
    ...
    private $view     =  "admin.language.";
    private $action   =  "/admin/languages";
    private $db_key   =  "id";
    private $user = [];
    private $perpage = 10;
    ...
    function index(Request $request){
        ...
        $data['list']   =   Language::paginate($this->perpage)->toArray();
        $data['module'] = [
            'type'=>$this->type,
    ...
    public function edit(Request $request,$id = NULL)
    {
        ...
        $data['row'] = Language::find($id)->toArray();
