...
.slide::-webkit-scrollbar-track {
  ...
  .slide::-webkit-scrollbar-thumb {
   box-shadow: inset 0 0 6px  #9d43ac;
   border-radius: 15px;
}
...
.slide-down::-webkit-scrollbar-track {
  background-color: transparent;
}

.slide-down::-webkit-scrollbar-thumb {
   box-shadow: inset 0 0 6px  #9d43ac;
   border-radius: 15px;
}
...
<div class="row " style="justify-content: flex-end;">
   <div class="col-md-2 col-sm-2 col-lg-2 mb-3 mt-4 slide slide-down ">

      <ul class="pl-3">
         <div>
            <h3 class="nbt first_abt">
               <a href="#" class="mlo ">About <button class="btn-1 burger"><i class="fa fa-bars"></i></button></a>
            </h3>
         </div>
         <div class="side-menu">
            <div class="submenu">
               <li>
                  <a href="#">sdgvuyfansclk</a>
               </li>

               <li>
                  <a href="#">sdgvuyfasdfansclk</a>
               </li>
               <li>
                  <a href="#">sdgvuyfansclk</a>
               </li>
            ...
            <h3 class="nbt"><a href="#" class="mlo">About</a></h3>
            <div class="submenu">
               <li>
                  <a href="#">sdgvuyfansclk</a>
               </li>
   ...
   <div class="col-md-10">
      ...
      <div class="tab-content jumbotron " style="min-height: 400px">
         <div id="All" class="container-fluid tab-pane {{ ($type != 'free' && $type != 'paid')?'active':'fade' }}">
            <br>
         ...
         <div id="Paid" class="container-fluid tab-pane {{ ($type == 'paid')?'active':'fade' }}">
            <br>
            <div class="container-fluid">
               <div class="row hover">
         ...
         <div id="Free" class="container-fluid tab-pane {{ ($type == 'free')?'active':'fade' }}">
            <br>
            <div class="container-fluid ">
               <div class="row hover">
