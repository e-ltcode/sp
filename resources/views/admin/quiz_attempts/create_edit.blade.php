            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="course_id" id="course_id" class="form-control">
                            ...
                            <option @if(@$row['course_id']==$v['id']) selected="" @endif value="{{ $v['id'] }}">{{
                                $v['course_name'] }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="std_id" id="std_id" class="form-control">
                            ...
                            <option @if(@$row['std_id']==$v['id']) selected="" @endif value="{{ $v['id'] }}">{{
                                $v['name'] }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type='text' name="quiz_result" id="quiz_result" class="form-control" required=""
                            value="{{@$row['quiz_result']}}" />
                    </div>
                </div>
