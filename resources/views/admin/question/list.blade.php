...
<div class="card-toolbar">
	...
	<a href="javascript:void(0);" data-target="#data_modal" data-toggle="modal"
		onclick="loadModal('{{$module['action']}}/create')"
		class="fcbtn btn btn-info btn-outline btn-1c">New {{@$module['singular']}}</a>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="white-box">
									...
									<div class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li><a class="dropdown-item"
													href="{{ url('instructor/answers/'.$val[$module['db_key']]) }}"><i
														class="fa fa-eye"></i> Answers</a> </li>
											@elseif(Auth::user()->role == 1)
											<li><a class="dropdown-item"
													href="{{ url('admin/answers/'.$val[$module['db_key']]) }}"><i
														class="fa fa-eye"></i> Answers</a> </li>
											@endif
										</ul>
									</div>
