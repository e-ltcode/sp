...
<div class="card-toolbar">
	<!--begin::Button-->
	<a href="javascript:void(0);" data-target="#data_modal" data-toggle="modal" onclick="loadModal('{{$module['action']}}/create/{{ @$selected_quiz }}')" class="fcbtn btn btn-info btn-outline btn-1c">New {{@$module['singular']}}</a>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="white-box">
								...
								<td style="">
									<div class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											@if(Auth::user()->role == 2)
											<li><a class="dropdown-item" href="{{ url('instructor/answers/'.$val[$module['db_key']]) }}"><i class="fa fa-eye"></i> Answers</a> </li>
											@elseif(Auth::user()->role == 1)
											<li><a class="dropdown-item" href="{{ url('admin/answers/'.$val[$module['db_key']]) }}"><i class="fa fa-eye"></i> Answers</a> </li>
											@endif
										</ul>
									</div>
								</td>
