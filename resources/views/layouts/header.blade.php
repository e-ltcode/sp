...
<body>
    <a id="button_top"><i class="fas fa-arrow-up fa-2x mt-2 text-white"></i></a>
    <nav class="navbar navbar-expand-md navbar-dark text-light bg-black" style="">
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="{{ asset('assets/images/new_logo.png') }}" class="img-fluid logo_img" style="width: 360px" alt="Responsive image">
        </a>
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            <form action="{{ url('marketplace') }}" class=" ml-auto search_form mr-auto d-none d-lg-block d-md-none" style="width:40%;">
                <div class="input-group ">
                    <input type="text" class="form-control rounded-pill" autocomplete="off" name="search" placeholder="Search Quizes" style="height: 49px;">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item text-center active">
                    @if(Auth::check())
                    <a class="icons nav-link" href="{{ url('quiz_attempts') }}">
                        <span class="icon">
                ...
                <li class="nav-item text-center">
                    <a class="icons nav-link" href="{{ url('marketplace') }}">
                        <span class="icon">
                ...
                <li class="nav-item text-center">
                    @if(Auth::check())
                    <a class="icons nav-link" href="{{ url('cart_items') }}" style="position: relative;">
                        @if(Auth::user()->cart_items()->count() > 0)
                        <span class="badge badge-warning" style="position: absolute;top: 6px;margin-left: 17px;">{{ Auth::user()->cart_items()->count() }}</span>
                        @endif
                        <span class="icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                @if(Auth::check())
                <li class="nav-item text-center">
                    <a class="icons nav-link" href="{{ url('/logout') }}">
                ...
                @else
                <li class="nav-item text-center">
                    <a class="icons nav-link" href="{{ url('/login') }}">
                ...
                <li class="nav-item text-center">
                    <a class="icons nav-link" href="{{ url('/register') }}">
    ...
    <div class="header" style="display: none;">
        ...
        <div class="icons-top" id="hide" style="display: flex;justify-content: space-between;">
            <a class="icons" href="{{ url('') }}" style="background-color: #000;">
                <img src="{{ asset('assets/images/new_logo.png') }}" class="img-fluid" style="width: 300px" alt="Responsive image">
            </a>
            <div class="image">
