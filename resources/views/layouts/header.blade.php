                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-4 mb-30 my-3">
                            <div class="single-cta">
                                ...
                                <div class="cta-text">
                                    <a href="https://www.google.com/maps?q=Punjab,+Pakistan" target="_blank" class="text-decoration-none"><h4>Find us</h4></a>
                        ...
                        <div class="col-xl-4 col-md-4 mb-30 my-3">
                            <div class="single-cta">
                                ...
                                <div class="cta-text">
                                    <a href="tel:090078601" class="text-decoration-none"><h4>Call us</h4></a>
                                    <span>090078601</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-md-4 mb-30 my-3">
                            ...
                            <div class="socialbtns pt-4">
                                <ul>
                                    ...
                                    <li><a href="https://www.instagram.com/svarogproject/" target="_blank" class="fab fa-instagram text-white"></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                            <div class="copyright-text">
                                <p>Copyright &copy; {{ date('Y') }} SvarogProject, all Rights Reserved </p>
                            </div>
                        </div>
