                        ...
                        <ul class="dropdown-menu mailbox animated bounceInDown">
                            ...
                            <li>
                                <div class="message-center">
                                    ...
                                    <a href="#">
                                        <div class="user-img"> 
                                            {{-- <img src="{{ asset('ample/plugins/images/users/sonu.jpg') }}" alt="user" class="img-circle"> --}}
                                    ...
                                    <a href="#">
                                        <div class="user-img"> 
                                            {{-- <img src="{{ asset('ample/plugins/images/users/arijit.jpg') }}" alt="user" class="img-circle"> --}}
                                            <img src="" alt="user" class="img-circle">
                                    ...
                                    <a href="#">
                                        <div class="user-img"> 
                                            {{-- <img src="{{ asset('ample/plugins/images/users/pawandeep.jpg') }}" alt="user" class="img-circle"> --}}
                                            <img src="" alt="user" class="img-circle">
